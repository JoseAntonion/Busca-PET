...
interface PetDao {
    ...
    @Query("SELECT * FROM pet WHERE description = :description")
    ...
    @Query("SELECT * FROM pet WHERE reporter_id = :reporterId")
    fun getPetsByReporter(reporterId: String): Flow<List<Pet>>
